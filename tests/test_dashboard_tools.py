...
class TestGetServerTools:
    ...
    def test_backend_disconnected_returns_empty_tools(self, client: TestClient, mock_deps: ServerDependencies):
    ...
    def test_tool_description_defaults_to_empty_string(self, client: TestClient, mock_deps: ServerDependencies):
    ...
    def test_no_config_manager_returns_empty_disabled(self, client: TestClient, mock_deps: ServerDependencies):
...
class TestDashboardToolLoadingScenarios:
    ...
    def test_dashboard_fetches_tools_for_all_backends(self, client: TestClient, mock_deps: ServerDependencies):
        ...
        mock_deps.backend_manager.backends = {
            "memory": MockBackend(
                ...
                connected=True,
                tools=[
                    Tool(name="create_entities", description="Create memory entities", inputSchema={}),
...
class TestBackendConnectionProperty:
    ...
    def test_backend_tools_returns_copy(self):
        ...
        # Set internal tools
        backend._tools = [
            Tool(name="tool1", description="Test", inputSchema={})
        ]
