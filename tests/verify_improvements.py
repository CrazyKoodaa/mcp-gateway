...
def test_path_security():
    ...
    print(f"    Debug: /etc/passwd -> is_sensitive={result.is_sensitive}, pattern={result.matched_pattern}")
    ...
    print(f"    Debug: /home/user/.ssh -> is_sensitive={result.is_sensitive}, pattern={result.matched_pattern}")
    assert result.is_sensitive
    
    # Test wildcard with file extension pattern
    result = service.check_path("/home/user/secrets.pem")
    print(f"    Debug: /home/user/secrets.pem -> is_sensitive={result.is_sensitive}, pattern={result.matched_pattern}")
    assert result.is_sensitive
